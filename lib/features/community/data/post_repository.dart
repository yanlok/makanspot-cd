...
class PostRepository {
  ...
  Future<List<PostModel>> getFeed({int limit = 10, int offset = 0}) async {
    ...
    // Complex query to get post data + user info + restaurant info + like status
    ...
    return (data as List).map((json) {
      ...
      final isLiked = userId != null && likes != null && 
          likes.any((l) => l['user_id'] == userId);
      final isBookmarked = userId != null && bookmarks != null && 
          bookmarks.any((b) => b['user_id'] == userId);
